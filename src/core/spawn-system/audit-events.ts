 ...
 * spawn-system 审计事件常量 / phase 766 sync 路径 wire / phase 11 template reject 加 TEMPLATE_UNKNOWN.
 *
 * 注：现有 spawn 工具 async 路径经 AsyncTaskSystem.schedule 内 TASK_AUDIT_EVENTS.TASK_SCHEDULED 落 audit /
