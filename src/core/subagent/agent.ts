...
export interface SubAgentOptions {
  ...
  prompt: string;
  /** phase 1489 (ML#8 derive): caller 装配期 own ToolExecutor 构造 / SubAgent 不再 own 7 个 executor-only 字段（clawDir/clawforumRoot/syncDir/fsFactory/workspaceDir/subagentMaxSteps/toolTimeoutMs）。 */
