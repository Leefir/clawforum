...
const BASELINE_ALLOW_LIST = new Set([
  ...
  'src/core/summon-system/internal/shadow/constants.ts',
  'src/core/summon-system/internal/shadow/spawn-shadow-subagent.ts',
  'src/core/summon-system/internal/shadow/system.ts',
  'src/core/summon-system/internal/shadow/tools/shadow.ts',
  'src/core/summon-system/internal/shadow/types.ts',
